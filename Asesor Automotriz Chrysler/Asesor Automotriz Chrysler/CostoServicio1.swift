...
class CostoServicio1: UIViewController,UITextFieldDelegate, MFMessageComposeViewControllerDelegate,MFMailComposeViewControllerDelegate {
    ...
    @IBAction func continuarButton(_ sender: AnyObject) {
        ...
        if (!validateEmail(emailCliente!)){
         ...
         [self .performSegue(withIdentifier: "costo1a2", sender: self)]
     ...
     override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        ...
        if "costo1a2" == segue.identifier {
        let costo2: CostoServicio2 = segue.destination as! CostoServicio2
        
        costo2.receivedNombre = nombreTextField.text!
        costo2.receivedEmail = emailTextField.text!
        costo2.receivedCelular = celularTextField.text!
        costo2.receivedTelefono = telefonoTextField.text!
        }
    }
