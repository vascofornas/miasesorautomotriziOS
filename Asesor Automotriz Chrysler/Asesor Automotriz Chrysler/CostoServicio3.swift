...
class CostoServicio3: UIViewController,UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate,MFMessageComposeViewControllerDelegate,MFMailComposeViewControllerDelegate {
    ...
    @IBAction func continuarButton(_ sender: AnyObject) {
        ...
        [self .performSegue(withIdentifier: "costo3a4", sender: self)]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        ...
        if "costo3a4" == segue.identifier {
            let costo4: CostoServicio4 = segue.destination as! CostoServicio4
            
            costo4.receivedNombre = receivedNombre
            costo4.receivedEmail = receivedEmail
            costo4.receivedCelular = receivedCelular
            costo4.receivedTelefono = receivedTelefono
            costo4.receivedVehiculo = receivedVehiculo
            costo4.receivedAno = anoTextField.text!
